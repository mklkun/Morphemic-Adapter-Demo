...
public class AdapterDemoDockerThreaded {

    private static final Logger LOGGER = Logger.getLogger(AdapterDemoDockerThreaded.class);

    private static final String EXAMPLES_RELATIVE_PATH = "Example_Docker" + File.separator;
    ...
    public static void main(String[] args) {
        ...
        JSONObject jsonJob = new JSONObject(Utils.getContentWithFileName(EXAMPLES_RELATIVE_PATH + "JobTask_docker_input.json"));
